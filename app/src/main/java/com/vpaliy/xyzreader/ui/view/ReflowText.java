...
public class ReflowText extends Transition {
    ...
    public static void addExtras(@NonNull Intent intent, TextView view){
        intent.putExtra(view.getTransitionName(),new ReflowData(new ReflowableTextView(view)));
    }
    ...
    public static void setupReflow(@NonNull Intent intent, @NonNull View view) {
        view.setTag(R.id.tag_reflow_data, intent.getParcelableExtra(view.getTransitionName()));
    }
    ...
    public static class ReflowableTextView implements Reflowable<TextView> {
        ...
        public String getFontName() {
            String name = TransitionUtils.getName(textView.getTypeface());
